...
namespace UnitConversion
{
    ...
    {
        /// <value>
        /// An invalid conversion object used for reporting unsupported unit 
        /// types.
        /// </value>
        private Conversion _conversion;

        /// <value>
        /// Convert objects are stored in a dictionary indexed by unit type.  
        /// The map contains all the single unit types for which unit  
        /// conversions are supported.
        /// </value>
        private Dictionary<string, Converter> _map;
        ...
        /// <summary>
        /// The Instance static method creates and instance of the 
        /// UnitConversion class.  This class is a singleton and is used 
        /// provides access to all the available unit conversions.See the 
        /// Convert class for more details.
        /// </summary>
        /// <returns>
        /// An instance of the UnitConversions class.
        /// </returns>
        ...
        public bool check()
        {
            foreach (KeyValuePair<string, Converter> kvp in _map)
            {
                Converter cv = kvp.Value;
                if (cv.check())
                {
                    continue;
                }
        ...
        /// </summary>
        /// <param><c>type</c> (input) name of unit type for which
        ///                            unit conversions are desired.</param>
        /// <returns>
        /// A Converter object for performing unit conversions
        ...
        /// </summary>
        /// <returns>
        /// A list of types available for unit conversion.
        /// </returns>
        ...
        private UnitConversions()  
        {
            ...
            _map = new Dictionary<string, Converter>();
