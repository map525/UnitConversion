...
namespace UnitConversionTestCS
{
    ...
    public class SystemTestSystemUnits : UnitConversionBaseTest
    {
        ...
        protected override void runOut()
        {
            ...
            List<string> eSysNames = new List<string>{"@",            "a.u.",          "UK",
            ...
            List<string> unitName = sysUnits.unitNames("Mass", "UK");
            ...
            testSystemUnitValue(sysUnits, "Length", "UK",            "foot",                              3.048000000000000E-001);
            testSystemUnitValue(sysUnits, "Length", "UK",            "foot(UK-old)",                      3.047997347632710E-001);
            testSystemUnitValue(sysUnits, "Length", "US",            "foot(US-survey)",                   3.048006096012190E-001);
            testSystemUnitValue(sysUnits, "Length", "US",            "vara(US-Texas)",                    8.466666666666670E-001);
            testSystemUnitValue(sysUnits, "Area",   "US",            "square-foot",                       9.290304000000001E-002);
            testSystemUnitValue(sysUnits, "Area",   "US",            "vara(US-Texas)",                    7.168601466640000E+002);
            testSystemUnitValue(sysUnits, "Mass",   "US",            "pound",                             4.535923700000000E-001);
            testSystemUnitValue(sysUnits, "Mass",   "UK",            "pound(UK-Imperial)",                4.535923380000000E-001);
            testSystemUnitValue(sysUnits, "Mass",   "UK_US_Apoth",   "pound(apothecary)",                 3.732417216000000E-001);
            testSystemUnitValue(sysUnits, "Liquid", "UK",            "gallon(UK)",                        4.546092000000000E-003);
            testSystemUnitValue(sysUnits, "Liquid", "US",            "gallon(US)",                        3.785411784000000E-003);
            testSystemUnitValue(sysUnits, "Liquid", "UK",            "gallon(UK-beer)",                   4.621152048000000E-003);
            testSystemUnitValue(sysUnits, "Liquid", "French",        "liter(old)",                        1.000002800100000E-003);
            testSystemUnitValue(sysUnits, "Dry",    "UK",            "gallon(UK)",                        4.546092000000000E-003);
            testSystemUnitValue(sysUnits, "Dry",    "US",            "gallon(US)",                        4.404883770860000E-003);
            ...
            testSystemUnitValue(sysUnits, "Length", "Malagasy",      "rahf",                              1.180084000000000E+000);
            testSystemUnitValue(sysUnits, "Area",   "Malagasy",      "square-rahf",                       1.392598247056000E+000);
            testSystemUnitValue(sysUnits, "Mass",   "Malagasy",      "nanki",                             6.479891000000000E-004);
            testSystemUnitValue(sysUnits, "Liquid", "Malagasy",      "cubic-rahf",                        1.643382909778830E+000);
            testSystemUnitValue(sysUnits, "Dry",    "Malagasy",      "bambou",                            2.001579185478780E-003);
            testSystemUnitValue(sysUnits, "Length", "Tanzanian",     "ohra",                              5.709920000000000E-001);
            testSystemUnitValue(sysUnits, "Area",   "Tanzanian",     "square-ohra",                       3.260318640640000E-001);
            testSystemUnitValue(sysUnits, "Mass",   "Tanzanian",     "mane",                              9.104052458270000E-001);
            testSystemUnitValue(sysUnits, "Liquid", "Tanzanian",     "cubic-ohra",                        1.861615861256320E-001);
            testSystemUnitValue(sysUnits, "Dry",    "Tanzanian",     "djezla",                            2.574214075690580E-001);
            testSystemUnitValue(sysUnits, "Length", "Afghan",        "gaz-i-shah",                        1.065000000000000E+000);
            testSystemUnitValue(sysUnits, "Area",   "Afghan",        "jareeb",                            2.000000000000000E+003);
            testSystemUnitValue(sysUnits, "Mass",   "Afghan",        "nakhud",                            1.900000000000000E-004);
            testSystemUnitValue(sysUnits, "Liquid", "Afghan",        "cubic-gaz-i-shah",                  1.207949625000000E+000);
            testSystemUnitValue(sysUnits, "Dry",    "Afghan",        "cubic-gaz-i-shah",                  1.207949625000000E+000);
            testSystemUnitValue(sysUnits, "Length", "Korean",        "cheok",                             3.030303030303030E-001);
            testSystemUnitValue(sysUnits, "Area",   "Korean",        "pyeong",                            3.305785123966940E+000);
            testSystemUnitValue(sysUnits, "Mass",   "Korean",        "gwan",                              3.750000000000000E+000);
            testSystemUnitValue(sysUnits, "Liquid", "Korean",        "doe",                               1.803906836964690E-003);
            testSystemUnitValue(sysUnits, "Dry",    "Korean",        "cubic-cheok",                       2.782647410746580E-002);
            testSystemUnitValue(sysUnits, "Length", "Omani",         "muscat",                            9.939020000000000E-001);
            testSystemUnitValue(sysUnits, "Area",   "Omani",         "square-muscat",                     9.878411856040000E-001);
            testSystemUnitValue(sysUnits, "Mass",   "Omani",         "maund",                             3.968933237500000E+000);
            testSystemUnitValue(sysUnits, "Liquid", "Omani",         "ferren",                            3.000090255291360E-002);
            testSystemUnitValue(sysUnits, "Dry",    "Omani",         "cubic-muscat",                      9.818173300541870E-001);
            testSystemUnitValue(sysUnits, "Length", "Pakistani",     "karam",                             1.676400000000000E+000);
            testSystemUnitValue(sysUnits, "Area",   "Pakistani",     "square-karam",                      2.810316960000000E+000);
            testSystemUnitValue(sysUnits, "Mass",   "Pakistani",     "tola",                              1.166375000000000E-002);
            testSystemUnitValue(sysUnits, "Liquid", "Pakistani",     "cubic-karam",                       4.711215351744000E+000);
            testSystemUnitValue(sysUnits, "Dry",    "Pakistani",     "cubic-karam",                       4.711215351744000E+000);
            testSystemUnitValue(sysUnits, "Length", "Taiwanese",     "chhioh",                            3.030303030303030E-001);
            testSystemUnitValue(sysUnits, "Area",   "Taiwanese",     "pe",                                3.305785123966940E+000);
            testSystemUnitValue(sysUnits, "Mass",   "Taiwanese",     "nu",                                3.750000000000000E-002);
            testSystemUnitValue(sysUnits, "Liquid", "Taiwanese",     "liter",                             1.000000000000000E-003);
            testSystemUnitValue(sysUnits, "Dry",    "Taiwanese",     "cubic-chhioh",                      2.782647410746580E-002);
            testSystemUnitValue(sysUnits, "Length", "Tamil",         "yaar",                              9.333123317760000E-001);
            testSystemUnitValue(sysUnits, "Area",   "Tamil",         "cent",                              4.046856422400000E+001);
            testSystemUnitValue(sysUnits, "Mass",   "Tamil",         "palam",                             4.800000000000000E-002);
            testSystemUnitValue(sysUnits, "Liquid", "Tamil",         "padi",                              1.344000000000000E-003);
            testSystemUnitValue(sysUnits, "Dry",    "Tamil",         "padi",                              1.344000000000000E-003);
            testSystemUnitValue(sysUnits, "Length", "Nepalese",      "angul",                             1.905000000000000E-002);
            testSystemUnitValue(sysUnits, "Area",   "Nepalese",      "dam",                               1.987254090000000E+000);
            testSystemUnitValue(sysUnits, "Mass",   "Nepalese",      "tola",                              1.166000000000000E-002);
            testSystemUnitValue(sysUnits, "Liquid", "Nepalese",      "pathi",                             4.545960000000000E-003);
            testSystemUnitValue(sysUnits, "Dry",    "Nepalese",      "cubic-angul",                       6.913292625000000E-006);
            testSystemUnitValue(sysUnits, "Length", "Byzantine",     "pous",                              3.085000000000000E-001);
            testSystemUnitValue(sysUnits, "Area",   "Byzantine",     "pous",                              9.517225000000000E-002);
            testSystemUnitValue(sysUnits, "Mass",   "Byzantine",     "ogkia",                             2.725000000000000E-002);
            testSystemUnitValue(sysUnits, "Liquid", "Byzantine",     "xestes",                            5.492800000000000E-004);
            testSystemUnitValue(sysUnits, "Dry",    "Byzantine",     "cubic-pous",                        2.936063912500000E-002);
            testSystemUnitValue(sysUnits, "Length", "Tatar",         "sajin",                             2.133600000000000E+000);
            testSystemUnitValue(sysUnits, "Area",   "Tatar",         "quadrat-sajin",                     4.552248960000000E+000);
            testSystemUnitValue(sysUnits, "Mass",   "Tatar",         "qadaq",                             4.095000000000000E-001);
            testSystemUnitValue(sysUnits, "Liquid", "Tatar",         "garnets",                           3.279733333333330E-003);
            testSystemUnitValue(sysUnits, "Dry",    "Tatar",         "cubic-qadaq",                       6.866915737500000E-002);
            testSystemUnitValue(sysUnits, "Length", "Sumerian",      "kus",                               5.186000000000000E-001);
            testSystemUnitValue(sysUnits, "Area",   "Sumerian",      "gin",                               2.689459600000000E-001);
            testSystemUnitValue(sysUnits, "Mass",   "Sumerian",      "mana",                              5.040000000000000E-001);
            testSystemUnitValue(sysUnits, "Liquid", "Sumerian",      "sila",                              1.000000000000000E-003);
            testSystemUnitValue(sysUnits, "Dry",    "Sumerian",      "cubic-kus",                         1.394753748560000E-001);
