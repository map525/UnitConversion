...
public class SystemTestSystemUnits extends UnitConversionBaseTest
{
   /* 
    * Constructor
    *
    ...
    */
    public SystemTestSystemUnits(boolean brief, String path) 
    {
         super(brief, path);
    ...
    */
    ...
    protected void runOut(PrintStream out)
    {
        ...
        List<String> expected = makeList("Length", 
                                         "Area", 
                                         "Mass", 
                                         "Liquid",
                                         "Dry", 
                                         "Volume");
        boolean r3 = compareList(types, expected);
        ...
        List<String> eSysNames = makeList("@",            "a.u.",          "UK",
                                          ...
                                          "Sumerian");
        boolean r4 = compareList(sysNames, eSysNames);
        ...
        boolean r5a = compareList(sysNamesLength, eSysNames);
        boolean r5b = compareList(sysNamesArea, eSysNames);
        boolean r5c = compareList(sysNamesMass, eSysNames);
        boolean r5d = compareList(sysNamesLiquid, eSysNames);
        boolean r5e = compareList(sysNamesDry, eSysNames);
        ...
        List<String> eUnitNames = makeList("Mass[pound]",
                                           "Mass[pound(UK-Imperial)]");
        boolean r6 = compareList(unitName, eUnitNames);
        ...
        printFooter("SystemTestSystemUnits", duration, out);
    }

    /*
     * Test a SystemUnits.
     * 
     * @param su      - (input) SystemUnits to test.
     * @param type    - (input) unit type.
     * @param system  - (input) unit system.
     * @param name    - (input) unit name.
     * @param out     - (input) stream to write results to.
     */
    private void testSystemUnitValue(SystemUnits su, 
                                     String type,
                                     String  system,
                                     String name,
                                     ...
                                     PrintStream out)
    {
        ...
        printResult(result, "SystemTestSystemUnits - " + type + "["+system+"]" + " - ", 
                    name, ""+value, ""+expectedValue, out);
    }
}
// EOF
