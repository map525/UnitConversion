...
/////////////////////////////////////////////////////////////////////////////////
//
// File SystemTestUnitConstants.cpp
//
 ...
 */
SystemTestConstants::SystemTestConstants(bool brief,
 ...
 */
void SystemTestConstants::runOut(std::ostream& out)
{
    clock_t start = clock();
    ...
    std::list<std::string> names = constants.names();
    std::list<std::string> expected = {"DerivedUnits", 
                                       "PhysicalConstants", 
                                       "PhysialDefinitions",
    ...
    const ConstantGroup& derivedUnits = constants.constant("DerivedUnits");
    const ConstantGroup& physicalConstants = constants.constant("PhysicalConstants");
    const ConstantGroup& physialDefinitions = constants.constant("PhysialDefinitions");
    const ConstantGroup& physicalMeasurements = constants.constant("PhysicalMeasurements");
    const ConstantGroup& si = constants.constant("SI");
    const ConstantGroup& WGS84Model = constants.constant("WGS84Model");
    ...
    printFooter("SystemTestConstants", diff, out);
}

/*
 * @brief Verify constant value.
 * 
 * @param[in] cg            - ConstantGroup containing value.
 * @param[in] cname         - constant name.
 * @param[in] expectedValue - expected value.
 * @param[in] out           - stream to write results to.
 */
void SystemTestConstants::testConstantValue(const ConstantGroup& cg, 
