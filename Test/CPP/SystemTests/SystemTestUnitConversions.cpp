...
/////////////////////////////////////////////////////////////////////////////////
//
// File SystemTestUnitConversions.cpp
//
 ...
 */
SystemTestUnitConversions::SystemTestUnitConversions(bool brief, 
 ...
 */
void SystemTestUnitConversions::runOut(std::ostream& out)
{
    clock_t start = clock();
    ...
    printFooter("SystemTestUnitConversions", diff, out);
}

/**
*  @brief Compute and write results of Converter test for volume.
* 
* @param[in] unitConversions - conversion to extract volume for testing.
* @param[in] out             - stream to write results to.
*/
void SystemTestUnitConversions::testVolume(UnitConversions& unitConversions,
                                           std::ostream& out)
{
    ...
    testType(unitConversions.converter("Volume"), "Volume", "UK", "cubic-inch", "US", 
                                             "fluid-ounce", out); 
 ...
 * @param[in] label - label to identify output results.
 * @param[in] fromSystem - name of 'from' system.
 * @param[in] fromUnit - name of 'from' unit.
 * @param[in] toSystem - name of 'to' system.
 * @param[in] toUnit - name of 'to' unit.
 * @param[in] out - stream to write results to.
 */
void SystemTestUnitConversions::testType(Converter& con, 
                                         ...
                                         std::ostream& out)
{
    ...
    std::string saveFromSystem = con.fromSystem();
    std::string saveToSystem = con.toSystem();

    con.toSystem(toSystem);
    con.fromSystem(fromSystem);

    std::string fullNameFrom = con.fullUnitName(fromSystem, fromUnit);
    std::string fullNameTo   = con.fullUnitName(toSystem, toUnit);
    std::string fromSysName = (fullNameFrom == fromUnit ? fromSystem : "");
    std::string toSysName   = (fullNameTo == toUnit ? toSystem : "");
    ...
    printResult(x1 == result, "SystemTestUnitConversions " + label, "convert",
                std::to_string(x0) + " " + fromSysName + " " + fullNameFrom + " = " + std::to_string(x1)     + " " + toSysName + " "+ fullNameTo, 
                std::to_string(x0) + " " + fromSysName + " " + fullNameFrom + " = " + std::to_string(result) + " " + toSysName + " "+ fullNameTo, 
                out);

    printResult(x2 == result, "SystemTestUnitConversions " + label, "convert",
                std::to_string(x0) + " " + fromSysName + " " + fullNameFrom + " = " + std::to_string(x2)    + " " + toSysName + " " + fullNameTo, 
                std::to_string(x0) + " " + fromSysName + " " + fullNameFrom + " = " + std::to_string(result) + " " + toSysName + " "+ fullNameTo, 
                out);

    printResult(x3 == result, "SystemTestUnitConversions " + label, "convert",
                std::to_string(x0) + " " + fromSysName + " " + fullNameFrom + " = " + std::to_string(x3)     + " " + toSysName + " "+ fullNameTo, 
                std::to_string(x0) + " " + fromSysName + " " + fullNameFrom + " = " + std::to_string(result) + " " + toSysName + " "+ fullNameTo, 
                out);
}
// EOF
